...
# coq_makefile OTHERFLAGS =  COQLIBS =  -install none Maps.v Imp.v Preface.v Equiv.v Hoare.v Hoare2.v HoareAsLogic.v Smallstep.v Types.v Stlc.v StlcProp.v MoreStlc.v Sub.v Typechecking.v Records.v References.v RecordSub.v Norm.v LibTactics.v UseTactics.v UseAuto.v PE.v Postscript.v Bib.v -o Makefile 
#
...
.merlin:
	...
	@echo "B /Users/bcpierce/home/sf/plf/full" >> .merlin
	@echo "S /Users/bcpierce/home/sf/plf/full" >> .merlin
