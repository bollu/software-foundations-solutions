...
Theorem no_whiles_ifb_splits_over_terms: forall (c1 c2: com) (cond: bexp),
    no_whiles (IFB cond THEN c1 ELSE c2 FI) = true -> no_whiles c1 && no_whiles c2 = true.
  intros.
  induction c1; induction c2; try(simpl; auto).
Qed.
...
Proof.
  ...
  - apply no_whiles_cseq_splits_over_terms in H.
    ...
    (* if *)
  -
    apply no_whiles_ifb_splits_over_terms in H.
    apply andb_prop in H.
    destruct H.
    apply no_whiles_CIf.
